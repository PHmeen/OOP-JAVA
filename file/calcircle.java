...
public class calcircle {
    public static void main(String[] args) {
        ...
        try {
            System.out.print("กรุณาใส่ค่ารัศมีของวงกลม: ");
            ...
            System.out.println("ข้อผิดพลาดในการเขียนไฟล์: " + e.getMessage());
        } finally {
            scanner.close();
        }
